document.addEventListener('DOMContentLoaded', () => {
    ...
    function startGame() { 
        ...
        if (userFamilyHistory === 'Yes') riskScore += WEIGHTS.HIGH; 
    ...
    function updateRiskBar() {
        ...
        if (riskScore < 33) {
            ...
            riskFactorLabel.textContent = 'LOW RISK';
    ...
    function handleAnswer(direction) {
        ...
        if (userChoseAiyo) {
            ...
            riskScore += (WEIGHTS[question.riskWeight] || WEIGHTS.LOW);
